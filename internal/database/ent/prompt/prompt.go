...
const (
	...
	// FieldTemplatePath holds the string denoting the template_path field in the database.
	FieldTemplatePath = "template_path"
	// FieldTemplateContent holds the string denoting the template_content field in the database.
	FieldTemplateContent = "template_content"
	// FieldVariablesSchema holds the string denoting the variables_schema field in the database.
	FieldVariablesSchema = "variables_schema"
	...
	// FieldDefaultVariables holds the string denoting the default_variables field in the database.
	FieldDefaultVariables = "default_variables"
	// FieldRequiredVariables holds the string denoting the required_variables field in the database.
	FieldRequiredVariables = "required_variables"
	...
	// FieldStopSequences holds the string denoting the stop_sequences field in the database.
	...
	RepositoryColumn = "repository_prompts"
	// DependenciesTable is the table that holds the dependencies relation/edge.
	DependenciesTable = "prompt_dependencies"
	// DependenciesInverseTable is the table name for the PromptDependency entity.
	// It exists in this package in order to avoid circular dependency with the "promptdependency" package.
	DependenciesInverseTable = "prompt_dependencies"
	// DependenciesColumn is the table column denoting the dependencies relation/edge.
	DependenciesColumn = "prompt_dependencies"
)
...
var Columns = []string{
	...
	FieldVariablesSchema,
	FieldPromptType,
	FieldContextWindow,
	FieldDefaultVariables,
	FieldRequiredVariables,
	FieldLanguage,
...
func StabilityValidator(s Stability) error {
	...
	case StabilityEXPERIMENTAL, StabilityBETA, StabilitySTABLE, StabilityDEPRECATED:
		return nil
	default:
		return fmt.Errorf("prompt: invalid enum value for stability field: %q", s)
	}
}
...
func MaturityValidator(m Maturity) error {
	...
	case MaturityALPHA, MaturityBETA, MaturitySTABLE, MaturityMATURE:
		return nil
	default:
		return fmt.Errorf("prompt: invalid enum value for maturity field: %q", m)
	}
}
...
// PromptTypeTEMPLATE is the default value of the PromptType enum.
const DefaultPromptType = PromptTypeTEMPLATE
...
func PromptTypeValidator(pt PromptType) error {
	switch pt {
	case PromptTypeSYSTEM, PromptTypeUSER, PromptTypeASSISTANT, PromptTypeFUNCTION, PromptTypeTEMPLATE:
		return nil
	default:
...
// ByTemplatePath orders the results by the template_path field.
func ByTemplatePath(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldTemplatePath, opts...).ToFunc()
}

// ByTemplateContent orders the results by the template_content field.
func ByTemplateContent(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldTemplateContent, opts...).ToFunc()
}
