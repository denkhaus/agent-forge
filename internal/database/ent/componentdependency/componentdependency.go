...
const (
	// Label holds the string label denoting the componentdependency type in the database.
	...
	// Table holds the table name of the componentdependency in the database.
	Table = "component_dependencies"
	// ComponentTable is the table that holds the component relation/edge.
	ComponentTable = "component_dependencies"
	...
	ComponentColumn = "component_dependencies"
)

// Columns holds all SQL columns for componentdependency fields.
var Columns = []string{
	FieldID,
	FieldType,
	FieldDependencyName,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "component_dependencies"
...
func TypeValidator(_type Type) error {
	...
	case TypeRUNTIME, TypeBUILD, TypeOPTIONAL, TypePEER:
		return nil
	default:
		return fmt.Errorf("componentdependency: invalid enum value for type field: %q", _type)
	}
}

// OrderOption defines the ordering options for the ComponentDependency queries.
