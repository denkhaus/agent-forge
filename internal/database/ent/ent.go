...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			agentdependency.Table:     agentdependency.ValidColumn,
			component.Table:           component.ValidColumn,
			componentdependency.Table: componentdependency.ValidColumn,
			fork.Table:                fork.ValidColumn,
			localconfig.Table:         localconfig.ValidColumn,
			prompt.Table:              prompt.ValidColumn,
			promptdependency.Table:    promptdependency.ValidColumn,
			repository.Table:          repository.ValidColumn,
			syncoperation.Table:       syncoperation.ValidColumn,
			tool.Table:                tool.ValidColumn,
			tooldependency.Table:      tooldependency.ValidColumn,
		})
	})
