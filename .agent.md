...
**After every minor milestone** the agent must:

- Enforce: [Dependency Injection](./DI_ENFORCEMENT_PLAN.md)
- Enforce: [Development workflow](./DEV_WORKFLOW.md)
- Keep in Mind: [Prompt Workbench](./PROMPT_WORKBENCH_PLAN.md)
- Use [Bubbeltea best practices](./workspace/bubbletea-reference/README.md)
- Enforce: File size constrains
- Diminish the use of Unicode characters in code files and markdown.

If the agent does not take this into account, he will not do his job as good as he can.
